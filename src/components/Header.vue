...
watchEffect(() => {
    console.log('curRoute: ', curRoute.value);
})
</script>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <NuxtLink to="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AnOcCho</span>
            </NuxtLink>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <template v-for="(item, index) in nav" :key="index">
                        <li :class="{ 'text-blue-500': item.to === curRoute }">
                            <NuxtLink 
