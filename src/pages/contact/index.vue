...
<template>
    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button @click="toggle()" data-collapse-toggle="mobile-menu-2" type="button"
        ...
        <div class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1 hidden" :class="{ '!block': isShowMenu }" id="mobile-menu-2">
